...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <!-- START @FAVICONS -->
        <link href="{{$assetUrl}}img/ico/laravel/apple-touch-icon-144x144-precomposed.png" rel="apple-touch-icon-precomposed" sizes="144x144">
        <link href="{{$assetUrl}}img/ico/laravel/apple-touch-icon-114x114-precomposed.png" rel="apple-touch-icon-precomposed" sizes="114x114">
        <link href="{{$assetUrl}}img/ico/laravel/apple-touch-icon-72x72-precomposed.png" rel="apple-touch-icon-precomposed" sizes="72x72">
        <link href="{{$assetUrl}}img/ico/laravel/apple-touch-icon-57x57-precomposed.png" rel="apple-touch-icon-precomposed">
        <link href="{{$assetUrl}}img/ico/laravel/apple-touch-icon.png" rel="shortcut icon">
        <!--/ END FAVICONS -->
